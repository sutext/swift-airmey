    ...
    static func data(_ data:Data,scale:CGFloat=UIScreen.main.scale)->UIImage?{
        ...
        case .gif:
            ...
            for i in 0..<count{
                ...
                if let gifdic = (dic as NSDictionary).object(forKey: kCGImagePropertyGIFDictionary) as? NSDictionary {
        ...
        case .webp:
            ...
            for i in 0..<count{
                ...
                if #available(iOS 14.0, *) {
                    if let webpdic = (dic as NSDictionary).object(forKey: kCGImagePropertyWebPDictionary) as? NSDictionary {
                        if let dur = webpdic.object(forKey: kCGImagePropertyWebPUnclampedDelayTime) as? TimeInterval{
                            duration = duration + dur
                        }else if let dur = webpdic.object(forKey: kCGImagePropertyWebPDelayTime) as? TimeInterval{
                            duration = duration + dur
                        }
                    } else {
                        duration = 0.1
