...
class UpdateController: AMPopupController {
    ...
    override func viewDidLoad() {
        ...
        meaageLabel.text = "Test message Test message Test message Test message Test message Test message Test message Test message Test message Test message Test message Test message Test message "
